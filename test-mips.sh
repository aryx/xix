...
# case34_check_mips.s, case7_8_check_mips.s and
# case27_28_check_mips.s are deliberately NOT in this list: all nine
...
# certain MUL-result HI/LO read/write transitions, MTC1/MFC1
# COP1-transfer read/write transitions, and plain load-delay-slot
# reads, i.e. case 8/27/36) instead of what this port emits -- see
...
# case7_8_check_mips.s and case27_28_check_mips.s each inherit
# *both* that BEQ/JMP gap *and* their own respective hazard's
# NOP-padding gap (see mullohi_mips.s's, case30_31_mips.s's,
# case34_mips.s's, case7_8_mips.s's and case27_28_mips.s's own
...
# nine. Run any of them manually with scripts/diff-mips.sh to see
