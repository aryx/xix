#!/bin/sh
# Script to compile 'mk' without using 'mk' to generate a bin/mk
# so that we don't need a BOOTSTRAP/mk.
# Note that right now to boostrap xix we still need OCaml and a C
# compiler as well as sh.
#
