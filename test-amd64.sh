...
CASES=(
    ...
    "tests/linker/amd64_diff/muldiv.s:_start"
    "tests/linker/amd64_diff/test_instr.s:_start"
    "tests/linker/amd64_diff/float_ext.s:_start"
    "tests/linker/amd64_diff/cmpxchg.s:_start"
    "tests/linker/amd64_diff/psllq.s:_start"
