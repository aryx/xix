...
let check_usedef (program : Ast.program) : unit =
  ...
  (*s: function [[Check.check_usedef.toplevel]] *)
  let rec toplevel env = function
    (*s: [[Check.check_usedef.toplevel()]] match cases *)
    ...
    (*x: [[Check.check_usedef.toplevel()]] match cases *)
    ...
    | FuncDef { f_name = name; f_loc = loc; f_type = ftyp; f_body = st; f_storage = _ } ->
      ...
      check_labels env;
    (*e: [[Check.check_usedef.toplevel()]] match cases *)
  (*e: function [[Check.check_usedef.toplevel]] *)
  (*s: function [[Check.check_usedef.stmt]] *)
  and stmt env st0 =
    match st0.s with
    (*s: [[Check.check_usedef.stmt()]] match [[st0.s]] cases *)
    | ExprSt e -> expr env e
    | Block xs ->
        (* new block scope *)
        ...
        (* check block scope *)
        check_unused_locals env
    (*x: [[Check.check_usedef.stmt()]] match [[st0.s]] cases *)
    ...
    (*e: [[Check.check_usedef.stmt()]] match [[st0.s]] cases *)
  (*e: function [[Check.check_usedef.stmt]] *)
  (*s: function [[Check.check_usedef.expr]] *)
  and expr env e0 =
    match e0.e with
    (*s: [[Check.check_usedef.expr()]] match [[e0.e]] cases *)
    | Int _ | Float _ | String _ -> ()
    (*x: [[Check.check_usedef.expr()]] match [[e0.e]] cases *)
    | Id fullname ->
        (try 
    ...
    (*e: [[Check.check_usedef.expr()]] match [[e0.e]] cases *)
  and exprs env xs = xs |> List.iter (expr env)
  (*e: function [[Check.check_usedef.expr]] *)
  (*s: function [[Check.check_usedef.type_]] *)
  and type_ env = fun typ ->
    match typ.t with
    (*s: [[Check.check_usedef.type_()]] match [[typ.t]] cases *)
    | TBase _ -> ()
    ...
    (*x: [[Check.check_usedef.type_()]] match [[typ.t]] cases *)
    ...
    (*e: [[Check.check_usedef.type_()]] match [[typ.t]] cases *)
  in
  (*e: function [[Check.check_usedef.type_]] *)

  (*s: [[Check.check_usedef()]] set initial [[env]] *)
  let env = {
  ...
  in
  (*e: [[Check.check_usedef()]] set initial [[env]] *)
  fst program |> List.iter (toplevel env);

  (*s: [[Check.check_usedef()]] check used but not defined tags after program visit *)
  ...
  (*e: [[Check.check_usedef()]] check used but not defined tags after program visit *)
