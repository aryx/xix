...
let dev_cons = { Device.default with
  ...
  (*s: method [[Virtual_cons.dev_cons.read_threaded]] *)
  ...
  (*e: method [[Virtual_cons.dev_cons.read_threaded]] *)
  (*s: method [[Virtual_cons.dev_cons.write_threaded]] *)
  ...
  (*e: method [[Virtual_cons.dev_cons.write_threaded]] *)
}
...
let dev_consctl = { Device.default with
  ...
  (*s: method [[Virtual_cons.dev_consctl.open_]] *)
  ...
  (*e: method [[Virtual_cons.dev_consctl.open_]] *)
  (*s: method [[Virtual_cons.dev_consctl.close]] *)
  ...
  (*e: method [[Virtual_cons.dev_consctl.close]] *)
  (*s: method [[Virtual_cons.dev_consctl.write_threaded]] *)
  write_threaded = (fun _offset str (w : Window.t) ->
    match str with
    | "rawon" -> 
      (* less: holding *)
  ...
  (*e: method [[Virtual_cons.dev_consctl.write_threaded]] *)
}
