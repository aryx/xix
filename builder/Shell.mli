...
val exec_backquote : < caps; .. > ->
  Shellenv.t -> string (* sh stdin (recipe) *) -> string (* sh output *)
(*e: signature [[Shell.exec_backquote]] *)
(*s: signature [[Shell.exec_pipecmd]] *)
val exec_pipecmd : < caps ; .. > ->
  Shellenv.t -> string (* sh stdin (recipe) *) ->
  Fpath.t (* tmpfile containing sh output *)
(*e: signature [[Shell.exec_pipecmd]] *)

(* internals *)
(*s: signature [[Shell.exec_shell]] *)
val exec_shell: <Cap.exec; Cap.env; ..> ->
  Shellenv.t -> string list -> string list -> unit
