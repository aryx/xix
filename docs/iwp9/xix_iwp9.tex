...
% but also utilities (ed, hoc? grep? sed? awk?), and even windowing system rio!
% (with graphics!) and some rudimentary kernel.

% real original motiv was principia softwarica (see principia paper)
% to explain the code of plan9 (kernel, windowing system, graphics and
...
%   less dependencies, more traditional C and simple use of libc and stdio
%   (use of APE)
